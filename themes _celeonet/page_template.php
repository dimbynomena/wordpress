...
<div class="container-fluid thumbnail-background-pages" style="min-height: 625px; background-size: cover !important;background-position: 10%; background: url('<?php echo $customBackground['url']; ?>');">
